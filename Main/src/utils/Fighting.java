                ...
                while (Stillfighting) {
                    ...
                    if (PlayerChoice == 1) {
                        ...
                        if (playermissChance >= 9) {
                            ...
                            print("You sucessfully hit the enemy weilding " + playerdamage + " damage, inflicted into them which leaves them with " + enemies[Navigation.getCombatIndex()].getHealth() + " health");
                            print("The enemy sucessfully hit the you weilding " + enemydamage + " damage, inflicted into you which leaves you with " + enemies[Navigation.getCombatIndex()].getHealth() + " health");
                        }
